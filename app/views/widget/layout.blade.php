@extends('main')    
    @section('page-styles')
        ...
        <style>
        body {
            background: {{ $company->widget ? $company->widget->background : DEFAULT_WIDGET_BACKGROUND }};
        }
        
        .color-font {
            color : {{ $company->widget ? $company->widget->color : DEFAULT_WIDGET_COLOR }};
        }
        
        .background-default {
            background : {{ $company->widget ? $company->widget->header : DEFAULT_WIDGET_HEADER }} !important;
        }
        @if ($company->widget)
