            ...
            @if ($is_reviewed)
                <div class="row margin-top-normal">
                    <div class="col-sm-12 text-center color-font">
                        <h3><u>You have already left the review here.</u></h3>
                    </div>
                </div>
            @else
                <div id="js-div-feedback">
                    ...
                    <div class="row margin-top-xs">
                        ...
                        <div class="text-center col-sm-6 form-radio">
                            @if ($value->is_score)
                            <input id="js-number-rating" type="number" name="rating[]" class="rating" min=0 max=5 step=1 data-show-caption=false data-show-clear=false data-size='lg' value="3">
							...
							<div class="btn-group padding-top-sm" data-toggle="buttons">
								<label class="btn btn-default btn-lg" data-val=1 id="js-label-answer"><input type="radio" class="toggle"> Yes </label>
								<label class="btn btn-default btn-lg" data-val=0 id="js-label-answer"><input type="radio" class="toggle"> No </label>
							</div>						    
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row margin-top-sm">
                        <div class="col-sm-10 col-sm-offset-1">
                            <textarea class="form-control" name="description" rows="5" placeholder="Write feedback here..."></textarea>
                        </div>
                    </div>
                    
                    <div class="row margin-top-sm">
                        <div class="col-sm-10 col-sm-offset-1">
                            <button class="btn btn-primary btn-lg btn-block" type="button" id="js-btn-submit-review">Submit Review</button>
                        </div>
                    </div>
                </div>
                <div id="js-div-user" style="display: none;">
                    <div class="row margin-top-sm">
                        <div class="col-sm-10 col-sm-offset-1">
                            <p>Enter your information here. So we can register you as our customer.</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-10 col-sm-offset-1">                
                    ...
                    <div class="row margin-top-sm">
                        <div class="col-sm-10 col-sm-offset-1">
                            <button class="btn btn-primary btn-lg btn-block" type="button" id="js-btn-submit">Submit</button>
                        </div>
                    </div>
