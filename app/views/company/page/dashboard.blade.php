        ...
        <div class="col-sm-12">
            <form class="form-horizontal" method="get" action="{{ URL::route('company.dashboard') }}">
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control text-center" name="startDate" id="js-text-start-date" placeholder="Start Date" value="{{ $startDate }}">
                    </div>
                    <div class="col-sm-2">
                        <input type="text" class="form-control text-center" name="endDate" id="js-text-end-date" placeholder="End Date" value="{{ $endDate }}">
                    </div>
                    <div class="col-sm-2">
                        <button class="btn btn-primary" onclick="return onValidate();"><i class="fa fa-search"></i> Search</button>
                    </div>
                    <div class="col-sm-1">
                        &nbsp;
                    </div>                                
				...
				<div class="details">
					<div class="number">
					    ...
					    foreach ($feedbacks as $feedback) {
                            $avg += $feedback->scoreRatings()->avg('answer');
                        }
...
function onValidate() {
    if ($('#js-text-start-date').val() > $('#js-text-end-date').val()) {
        bootbox.alert("Select the period correctly.");
        return;
    }
    return true;
}
