	...
	<div class="portlet-body form">
        <form class="form-horizontal form-bordered form-row-stripped" method="post" action="{{ URL::route('company.widget.store') }}" enctype="multipart/form-data">
            <div class="form-body">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Header & Footer</label>
                    <div class="col-sm-6">
                        <select class="form-control" name="is_header">
                            <option value="1" {{ $company->widget && $company->widget->is_header ? 'selected' : '' }}>Show</option>
                            <option value="0" {{ $company->widget && !$company->widget->is_header ? 'selected' : '' }}>Hide</option>
                        </select>                          
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Registration Widget</label>
                    <div class="col-sm-9">
                        <p>
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">Offers Widget</label>
                    <div class="col-sm-9">
                        <p>
