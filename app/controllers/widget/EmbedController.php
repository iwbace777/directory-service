...
use Company as CompanyModel, User as UserModel, Store as StoreModel;
...
class EmbedController extends \BaseController {
    public function home($slug) {
        ...
        return View::make('widget.embed.home')->with($param);
    }
    ...
    public function login($slug) {
        ...
        $param['pageNo'] = 1;
        return View::make('widget.embed.login')->with($param);
    }
    ...
    public function signup($slug) {
        ...
        $param['pageNo'] = 2;        
        return View::make('widget.embed.signup')->with($param);        
    }
    ...
    public function submitReview($slug) {
        ...
        $alert['msg'] = 'You left the feedback successfully. You got the Offer. Check your email.';
        $alert['type'] = 'success';
