...
use View, Input, Redirect, Session, Validator, Response, Request, Log;
use Company as CompanyModel, Plan as PlanModel, Subscribe as SubscribeModel;
use Stripe;
...
class SubscribeController extends \BaseController {    
    public function index() {
        ...
        return View::make('company.subscribe.index')->with($param);
    }
    ...
    public function success() {
        ...
        return View::make('company.subscribe.success')->with($param);
    }    
    ...
    public function create($planCode) {
        ...
        $alert['msg'] = 'You subscribed successfully';
        $alert['type'] = 'success';
    ...
    public function cancel() {
        ...
        $alert['msg'] = 'Subscribed cancelled successfully';
        $alert['type'] = 'danger';
